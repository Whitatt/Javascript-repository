...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //If activePlayer is equal to 'O;, the o.pmg is placed in HTML.
...
function checkWinConditions() {
    ...
    // O 0, 3, 6 condition.
    else if (arrayIncludes('0O', '30', '6O'))  {  drawWinLine(100, 50, 100, 558)  }
    // O 1, 4, 7 condition.
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        // If the 3 variables we pass are all included in pour array true is
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        //This variables gets the html element of i.
